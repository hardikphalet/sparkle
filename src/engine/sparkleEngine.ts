...
export function convert(objects: SparkleObject[]): string {
    ...
    objects.forEach((object) => {
        resultString = resultString.concat(
            getFuncFromOperation(object.operator)(object)
        ).concat(";");
    });
    return resultString;
}
...
function equalsOperation(object: SparkleObject): string {
    ...
    let resultString: string = object.bind.concat(".eq:").concat(object.values[0]);
    return resultString;
}
...
function greaterThanOperation(object: SparkleObject): string {
    ...
    let resultString: string = object.bind.concat(".gt:").concat(object.values[0]);
    return resultString;
}
...
function lesserThanOperation(object: SparkleObject): string {
    ...
    let resultString: string = object.bind.concat(".lt:").concat(object.values[0]);
    return resultString;
}
...
function lesserThanOrEqualsOperation(object: SparkleObject): string {
    ...
    let resultString: string = object.bind.concat(".le:").concat(object.values[0]);
    return resultString;
}
...
function greaterThanOrEqualsOperation(object: SparkleObject): string {
    ...
    let resultString: string = object.bind.concat(".ge:").concat(object.values[0]);
    return resultString;
}
